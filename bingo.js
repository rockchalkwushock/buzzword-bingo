...
var _user$project$ViewHelpers$alert = F2(
...
var _user$project$ViewHelpers$primaryButton = F2(
	function (msg, name) {
		return A2(
...
var _user$project$Bingo$httpErrorToMessage = function (error) {
	var _p0 = error;
	switch (_p0.ctor) {
		case 'NetworkError':
...
var _user$project$Bingo$EnteringGame = {ctor: 'EnteringGame'};
var _user$project$Bingo$initialModel = {
	...
	nameInput: '',
	gameState: _user$project$Bingo$EnteringGame
};
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Bingo$ChangeGameState(_user$project$Bingo$EnteringGame)),
							_1: {ctor: '[]'}
						}
					},
					{
	...
	if (_p1.ctor === 'EnteringGame') {
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$ViewHelpers$primaryButton, _user$project$Bingo$SaveName, 'Save'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$ViewHelpers$primaryButton, _user$project$Bingo$CancelName, 'Cancel'),
						_1: {ctor: '[]'}
					}
				}
			});
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alertMessage: _elm_lang$core$Maybe$Just(
									_user$project$Bingo$httpErrorToMessage(_p2._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
	...
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$ViewHelpers$alert, _user$project$Bingo$CloseAlert, model.alertMessage),
					_1: {
						ctor: '::',
...
var Elm = {};
Elm['Bingo'] = Elm['Bingo'] || {};
if (typeof _user$project$Bingo$main !== 'undefined') {
    _user$project$Bingo$main(Elm['Bingo'], 'Bingo', undefined);
}
